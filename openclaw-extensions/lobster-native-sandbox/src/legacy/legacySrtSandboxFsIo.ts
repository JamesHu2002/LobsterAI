...
/**
 * Executes the final file-system mutation/read through the legacy adapter.
 ...
 */
export class LegacySrtSandboxFsIo implements SandboxFsIo {
  constructor(
