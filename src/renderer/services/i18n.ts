...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    scheduledTasksTemplateTechBriefingPrompt:
      '请收集并总结过去 24 小时的科技、AI 与产品动态，筛选 5-8 条与办公、研发和产品人群相关的重点。每条包含事件、影响、可跟进行动，并在结尾列出今天值得关注的关键词。完成后请把早报另存为 Markdown 文件：工作区的 reports/ 目录下、文件名「科技早报-<今天日期>.md」（例如 2026-08-07），供后续论文转发任务读取。',
    ...
    scheduledTasksFormNextTask: '成功执行后触发任务',
    scheduledTasksFormNextTaskNone: '不触发（默认）',
    scheduledTasksFormNextTaskHint: '该任务一次运行成功后，会自动触发所选任务（例如：早报生成后自动触发论文转发）',
    scheduledTasksTriggersNext: '成功后将触发',
    ...
    benchmark: '模型评测',
    benchmarkTitle: '模型评测',
    benchmarkSubtitle: '选择评测集与模型，一键评测 Agent 能力并生成性能报告',
    benchmarkNewRun: '新建评测',
    benchmarkBackToList: '返回列表',
    benchmarkDataset: '评测集',
    benchmarkModel: '模型',
    benchmarkStart: '开始评测',
    benchmarkCancel: '取消',
    benchmarkStop: '停止',
    benchmarkDelete: '删除',
    benchmarkRunListEmpty: '还没有评测记录，点击「新建评测」开始',
    benchmarkDatasetGaia: 'GAIA',
    benchmarkDatasetGaiaDesc: 'GAIA 2023 验证集，166 道需工具使用与多步推理的真实问题',
    benchmarkDatasetAgentBench: 'AgentBench',
    benchmarkDatasetAgentBenchDesc: 'AgentBench 横向思维谜题子集，自包含、无需外部环境',
    benchmarkDatasetDownload: '下载数据集',
    benchmarkDatasetDownloading: '下载中…',
    benchmarkDatasetLoaded: '已加载 {n} 题',
    benchmarkDatasetRefresh: '重新下载',
    benchmarkDatasetError: '加载失败',
    benchmarkDatasetGatedHint: 'GAIA 为 HF 门禁数据集，需在设置中配置 HF Token',
    benchmarkCustomPick: '选择评测集文件（JSONL / JSON / CSV）',
    benchmarkCustomImport: '导入文件',
    benchmarkCustomReimport: '重新导入',
    benchmarkModelsAdd: '添加模型',
    benchmarkModelsRemove: '移除',
    benchmarkSelectModelPlaceholder: '选择模型…',
    benchmarkMaxSteps: '最大工具步数',
    benchmarkTimeoutMin: '每题超时（分钟）',
    benchmarkMaxTasks: '评测题数',
    benchmarkMaxTasksAll: '0 = 全量',
    benchmarkProgressDone: '{done}/{total} 已完成 · 通过 {passed} · 失败 {failed}',
    benchmarkStatusPending: '待运行',
    benchmarkStatusRunning: '评测中',
    benchmarkStatusCompleted: '已完成',
    benchmarkStatusFailed: '失败',
    benchmarkStatusCancelled: '已取消',
    benchmarkStatusPartial: '部分完成',
    // 技能制作流水线
    skillFactory: '技能工厂',
    skillFactoryTitle: '技能制作流水线',
    skillFactoryCreate: '新建制作',
    skillFactoryCreateTitle: '制作新技能',
    skillFactoryEmpty: '还没有制作任务，点击右上角开始',
    skillFactoryName: '技能名称（可选）',
    skillFactoryNamePlaceholder: '例如：会议纪要转待办',
    skillFactoryRequirement: '技能需求',
    skillFactoryRequirementRequired: '请填写技能需求',
    skillFactoryRequirementPlaceholder: '描述你想做的技能：用途、触发时机、输入输出、步骤、需要什么工具/资料…',
    skillFactoryDocs: '参考文档',
    skillFactoryAddDocs: '添加文档',
    skillFactoryDocsHint: '可选：提供需求文档/示例，流水线的需求解析 Agent 会参考它们',
    skillFactoryPickDocs: '选择参考文档',
    skillFactoryStart: '开始制作',
    skillFactoryStarting: '制作中…',
    skillFactoryStatusPending: '排队中',
    skillFactoryStatusRunning: '制作中',
    skillFactoryStatusReview: '待审阅',
    skillFactoryStatusInstalled: '已安装',
    skillFactoryStatusNeedsInput: '待补充需求',
    skillFactoryStatusFailed: '失败',
    skillFactoryStatusCancelled: '已取消',
    skillFactoryStagePreparing: '准备中',
    skillFactoryStageRequirements: '解析需求',
    skillFactoryStageMaking: '制作技能',
    skillFactoryStageEvaluating: '评估中',
    skillFactoryStageFinalizing: '收尾',
    skillFactoryEvalTitle: '评估结果',
    skillFactorySecurityTitle: '安全审查',
    skillFactoryPreview: 'SKILL.md 预览',
    skillFactoryNoPreview: '尚未生成 SKILL.md 预览',
    skillFactoryOpenDir: '打开目录',
    skillFactoryInstall: '安装到技能',
    skillFactoryInstalled: '已安装',
    skillFactoryInstallConfirm: '该技能包含安全风险项，是否仍要安装？',
    skillFactoryInstallConfirmTitle: '安全确认',
    skillFactoryInstallAnyway: '仍然安装',
    skillFactoryCancel: '取消',
    skillFactoryNeedsInputTitle: '需求信息不足，需要你补充',
    skillFactoryNeedsInputHint: '请补充上述信息后，新建一次制作任务。',
    skillFactorySource: '输入来源',
    skillFactorySourceManual: '手写需求',
    skillFactorySourceSessions: '从会话提炼',
    skillFactorySourceRuns: '从工作流提炼',
    skillFactorySourceIm: '从 IM 对话提炼',
    skillFactorySourceHint: '从真实交互/工作流中提炼技能规格（流水线的需求解析 Agent 会分析样本）',
    skillFactorySourceRequired: '请选择至少一个交互/工作流样本',
    skillFactoryPickSamples: '选择交互样本',
    skillFactoryNoSamples: '暂无可用样本',
    skillFactorySamplesHint: '可多选；样本越多，提炼出的技能越贴合真实使用',
    skillFactoryOptimize: '基于近期使用优化',
    skillFactoryOptimizeTitle: '选择用于优化的真实使用样本',
    skillFactoryNoUsage: '暂未找到使用过该技能的会话',
    skillFactoryOptimizeRun: '开始优化',
    // 模型能力评测（lm-evaluation-harness）
    modelEval: '模型能力评测',
    modelEvalTitle: '模型能力评测',
    modelEvalNew: '新建评测',
    modelEvalCreateTitle: '新建模型评测',
    modelEvalNote: '此模式用 lm-evaluation-harness 直接评测模型能力（单轮问答）。GAIA/AgentBench 转成单轮任务后分数会低于 Agent 式评测，仅供参考。',
    modelEvalInstallTitle: '评测框架',
    modelEvalInstallDesc: '需要安装 lm-evaluation-harness（Python 包，约 200MB）',
    modelEvalInstall: '安装框架',
    modelEvalInstalling: '安装中…',
    modelEvalInstalled: '已安装',
    modelEvalInstallFirst: '请先安装评测框架',
    modelEvalDataset: '评测集',
    modelEvalBuiltin: '内置评测集（lm-eval 自带）',
    modelEvalBuiltinHint: '这些由 lm-evaluation-harness 内置，首次运行会从 HuggingFace 下载；多选题需模型返回 logprobs（DeepSeek 支持）。',
    modelEvalCached: '已缓存',
    modelEvalNotCached: '未缓存',
    modelEvalModel: '模型',
    modelEvalSelectModel: '选择模型…',
    modelEvalNoModels: '暂无可用模型，请先在模型设置中配置',
    modelEvalFewshot: 'few-shot',
    modelEvalLimit: '样本上限(0=全部)',
    modelEvalMaxGenToks: '最大生成长度',
    modelEvalSelectAll: '请选择评测集与模型',
    modelEvalStart: '开始评测',
    modelEvalRunning: '评测中…',
    modelEvalStatusPending: '排队中',
    modelEvalStatusRunning: '评测中',
    modelEvalStatusCompleted: '已完成',
    modelEvalStatusFailed: '失败',
    modelEvalStatusCancelled: '已取消',
    modelEvalEmpty: '还没有评测任务，点击右上角开始',
    modelEvalCancel: '取消',
    modelEvalNoResults: '暂无结果',
    modelEvalShowSamples: '查看样本',
    modelEvalHideSamples: '收起样本',
    benchmarkSuccessRate: '任务成功率',
    benchmarkAvgTokens: '平均 Token',
    benchmarkAvgSteps: '平均步骤',
    benchmarkAvgToolCalls: '平均调用次数',
    benchmarkInvalidCallRate: '无效调用率',
    benchmarkToolAccuracy: '工具选择准确率',
    benchmarkParamAccuracy: '参数准确率',
    benchmarkRecoverability: '中间步骤可恢复性',
    benchmarkAvgCost: '平均成本',
    benchmarkTotalCost: '总成本',
    benchmarkTotalDuration: '总时长',
    benchmarkAvgDuration: '平均耗时',
    benchmarkCompareModels: '多模型对比',
    benchmarkAttachmentNote: '含附件 {n} 题（本次不加载附件）',
    benchmarkStatusPassed: '通过',
    benchmarkStatusFailedShort: '失败',
    benchmarkStatusError: '错误',
    benchmarkStatusTimeout: '超时',
    benchmarkStatusMaxSteps: '达步数上限',
    benchmarkStatusSkipped: '跳过',
    benchmarkStatusCancelledShort: '已取消',
    benchmarkRunStartFailed: '启动评测失败',
    benchmarkDatasetLoadFailed: '数据集加载失败',
    benchmarkNoModelSelected: '请至少选择一个模型',
    benchmarkNoDatasetLoaded: '请先下载评测集',
    benchmarkHfToken: 'HF Token',
    benchmarkHfTokenHint: '下载 GAIA 需要 Hugging Face 授权，填写你的 HF Token（仅保存在本地）',
    benchmarkTool: '工具',
    benchmarkSteps: '步骤',
    benchmarkTokens: 'Token',
    benchmarkCost: '成本',
    benchmarkDuration: '耗时',
    benchmarkViewDetail: '查看报告',
  ...
  en: {
    ...
    scheduledTasksTemplateTechBriefingPrompt:
      'Collect and summarize technology, AI, and product updates from the past 24 hours. Select 5-8 items relevant to office, engineering, and product teams. For each item, include what happened, why it matters, and a possible follow-up action. End with keywords worth watching today. When done, save the briefing as a Markdown file at reports/科技早报-<today\'s date>.md in the workspace (e.g. 2026-08-07) so the follow-up paper-forwarding task can read it.',
    ...
    scheduledTasksFormNextTask: 'Trigger next task on success',
    scheduledTasksFormNextTaskNone: 'No follow-up (default)',
    scheduledTasksFormNextTaskHint:
      'After this task runs successfully, the selected task is triggered automatically (e.g. tech briefing → paper forwarder)',
    scheduledTasksTriggersNext: 'Triggers next on success',
    ...
    benchmarkSubtitle: 'Pick a dataset and models to evaluate agent capability and generate a performance report',
    benchmarkNewRun: 'New Benchmark',
    benchmarkBackToList: 'Back to list',
    benchmarkDataset: 'Dataset',
    benchmarkModel: 'Model',
    benchmarkStart: 'Start Benchmark',
    benchmarkCancel: 'Cancel',
    benchmarkStop: 'Stop',
    benchmarkDelete: 'Delete',
    benchmarkRunListEmpty: 'No benchmark runs yet. Click "New Benchmark" to start.',
    benchmarkDatasetGaia: 'GAIA',
    benchmarkDatasetGaiaDesc: 'GAIA 2023 validation set, 166 real-world questions requiring tool use and multi-step reasoning',
    benchmarkDatasetAgentBench: 'AgentBench',
    benchmarkDatasetAgentBenchDesc: 'AgentBench lateral-thinking puzzles subset, self-contained, no external environment',
    benchmarkDatasetDownload: 'Download dataset',
    benchmarkDatasetDownloading: 'Downloading…',
    benchmarkDatasetLoaded: '{n} tasks loaded',
    benchmarkDatasetRefresh: 'Re-download',
    benchmarkDatasetError: 'Load failed',
    benchmarkDatasetGatedHint: 'GAIA is a gated HF dataset. Configure an HF Token in settings.',
    benchmarkCustomPick: 'Choose a dataset file (JSONL / JSON / CSV)',
    benchmarkCustomImport: 'Import file',
    benchmarkCustomReimport: 'Re-import',
    benchmarkModelsAdd: 'Add model',
    benchmarkModelsRemove: 'Remove',
    benchmarkSelectModelPlaceholder: 'Select a model…',
    benchmarkMaxSteps: 'Max tool steps',
    benchmarkTimeoutMin: 'Timeout per task (min)',
    benchmarkMaxTasks: 'Task limit',
    benchmarkMaxTasksAll: '0 = all',
    benchmarkProgressDone: '{done}/{total} done · {passed} passed · {failed} failed',
    ...
    benchmarkStatusCancelled: 'Cancelled',
    benchmarkStatusPartial: 'Partial',
    // Skill factory
    skillFactory: 'Skill Factory',
    skillFactoryTitle: 'Skill Factory',
    skillFactoryCreate: 'New Run',
    skillFactoryCreateTitle: 'Create a Skill',
    skillFactoryEmpty: 'No runs yet. Start one from the top-right.',
    skillFactoryName: 'Skill name (optional)',
    skillFactoryNamePlaceholder: 'e.g. meeting-minutes-to-actions',
    skillFactoryRequirement: 'Requirement',
    skillFactoryRequirementRequired: 'Please fill in the skill requirement',
    skillFactoryRequirementPlaceholder: 'Describe the skill you want: purpose, triggers, inputs/outputs, steps, tools/materials…',
    skillFactoryDocs: 'Reference docs',
    skillFactoryAddDocs: 'Add documents',
    skillFactoryDocsHint: 'Optional: provide requirement docs/examples for the requirements analyst to reference',
    skillFactoryPickDocs: 'Pick reference documents',
    skillFactoryStart: 'Start',
    skillFactoryStarting: 'Generating…',
    skillFactoryStatusPending: 'Queued',
    skillFactoryStatusRunning: 'Running',
    skillFactoryStatusReview: 'Ready to review',
    skillFactoryStatusInstalled: 'Installed',
    skillFactoryStatusNeedsInput: 'Needs input',
    skillFactoryStatusFailed: 'Failed',
    skillFactoryStatusCancelled: 'Cancelled',
    skillFactoryStagePreparing: 'Preparing',
    skillFactoryStageRequirements: 'Analyzing requirements',
    skillFactoryStageMaking: 'Making skill',
    skillFactoryStageEvaluating: 'Evaluating',
    skillFactoryStageFinalizing: 'Finalizing',
    skillFactoryEvalTitle: 'Evaluation',
    skillFactorySecurityTitle: 'Security scan',
    skillFactoryPreview: 'SKILL.md preview',
    skillFactoryNoPreview: 'SKILL.md preview not available yet',
    skillFactoryOpenDir: 'Open folder',
    skillFactoryInstall: 'Install skill',
    skillFactoryInstalled: 'Installed',
    skillFactoryInstallConfirm: 'This skill contains security risk findings. Install anyway?',
    skillFactoryInstallConfirmTitle: 'Security confirmation',
    skillFactoryInstallAnyway: 'Install anyway',
    skillFactoryCancel: 'Cancel',
    skillFactoryNeedsInputTitle: 'Insufficient requirements — input needed',
    skillFactoryNeedsInputHint: 'After providing the above, start a new run.',
    skillFactorySource: 'Input source',
    skillFactorySourceManual: 'Hand-written',
    skillFactorySourceSessions: 'From sessions',
    skillFactorySourceRuns: 'From workflows',
    skillFactorySourceIm: 'From IM chats',
    skillFactorySourceHint: 'Mine the skill spec from real interactions/workflows (the analyst analyzes the samples)',
    skillFactorySourceRequired: 'Pick at least one interaction/workflow sample',
    skillFactoryPickSamples: 'Pick interaction samples',
    skillFactoryNoSamples: 'No samples available',
    skillFactorySamplesHint: 'Multi-select; more samples produce a skill that better matches real usage',
    skillFactoryOptimize: 'Optimize from usage',
    skillFactoryOptimizeTitle: 'Pick real usage samples for optimization',
    skillFactoryNoUsage: 'No sessions found that used this skill',
    skillFactoryOptimizeRun: 'Start optimize',
    // Model eval (lm-evaluation-harness)
    modelEval: 'Model Capability Eval',
    modelEvalTitle: 'Model Capability Eval',
    modelEvalNew: 'New Run',
    modelEvalCreateTitle: 'New Model Eval',
    modelEvalNote: 'This mode evaluates model capability directly via lm-evaluation-harness (single-turn). GAIA/AgentBench as single-turn tasks score lower than the agent benchmark; treat as reference.',
    modelEvalInstallTitle: 'Eval framework',
    modelEvalInstallDesc: 'Installs lm-evaluation-harness (Python, ~200MB)',
    modelEvalInstall: 'Install',
    modelEvalInstalling: 'Installing…',
    modelEvalInstalled: 'Installed',
    modelEvalInstallFirst: 'Install the eval framework first',
    modelEvalDataset: 'Dataset',
    modelEvalBuiltin: 'Built-in (from lm-eval)',
    modelEvalBuiltinHint: 'These ship with lm-evaluation-harness and download from HuggingFace on first run; multiple-choice tasks need logprobs (DeepSeek supports them).',
    modelEvalCached: 'Cached',
    modelEvalNotCached: 'Not cached',
    modelEvalModel: 'Model',
    modelEvalSelectModel: 'Select model…',
    modelEvalNoModels: 'No models available. Configure one in model settings.',
    modelEvalFewshot: 'few-shot',
    modelEvalLimit: 'Sample limit (0=all)',
    modelEvalMaxGenToks: 'Max gen tokens',
    modelEvalSelectAll: 'Pick a dataset and a model',
    modelEvalStart: 'Start',
    modelEvalRunning: 'Running…',
    modelEvalStatusPending: 'Queued',
    modelEvalStatusRunning: 'Running',
    modelEvalStatusCompleted: 'Completed',
    modelEvalStatusFailed: 'Failed',
    modelEvalStatusCancelled: 'Cancelled',
    modelEvalEmpty: 'No runs yet. Start one from the top-right.',
    modelEvalCancel: 'Cancel',
    modelEvalNoResults: 'No results yet',
    modelEvalShowSamples: 'Show samples',
    modelEvalHideSamples: 'Hide samples',
    benchmarkSuccessRate: 'Task Success Rate',
    benchmarkAvgTokens: 'Avg Tokens',
    benchmarkAvgSteps: 'Avg Steps',
    benchmarkAvgToolCalls: 'Avg Tool Calls',
    benchmarkInvalidCallRate: 'Invalid Call Rate',
    benchmarkToolAccuracy: 'Tool Selection Accuracy',
    benchmarkParamAccuracy: 'Parameter Accuracy',
    benchmarkRecoverability: 'Step Recoverability',
    benchmarkAvgCost: 'Avg Cost',
    benchmarkTotalCost: 'Total Cost',
    benchmarkTotalDuration: 'Total Time',
    benchmarkAvgDuration: 'Avg Time',
    benchmarkCompareModels: 'Model Comparison',
    benchmarkAttachmentNote: '{n} tasks include attachments (not loaded in this run)',
    benchmarkStatusPassed: 'Passed',
    benchmarkStatusFailedShort: 'Failed',
    benchmarkStatusError: 'Error',
    benchmarkStatusTimeout: 'Timeout',
    benchmarkStatusMaxSteps: 'Max steps',
    benchmarkStatusSkipped: 'Skipped',
    benchmarkStatusCancelledShort: 'Cancelled',
    benchmarkRunStartFailed: 'Failed to start benchmark',
    benchmarkDatasetLoadFailed: 'Failed to load dataset',
    benchmarkNoModelSelected: 'Select at least one model',
    benchmarkNoDatasetLoaded: 'Download the dataset first',
    benchmarkHfToken: 'HF Token',
    benchmarkHfTokenHint: 'Downloading GAIA requires Hugging Face authorization. Paste your HF Token here (stored locally only).',
    benchmarkTool: 'Tool',
    benchmarkSteps: 'Steps',
    benchmarkTokens: 'Tokens',
    benchmarkCost: 'Cost',
    benchmarkDuration: 'Duration',
    benchmarkViewDetail: 'View Report',
